    ...
    public String getText() {
        ...
        text += switch (operator) {
            ...
            case MULTIPLY -> switch (story) {
                case APPLES -> "Пришёл добрый Виктор, забрал у Олега ящик с яблоками и вернул ему " + right + " таких ящиков. ";
                case ORANGES -> "Пришёл добрый Виктор, забрал у Олега ящик с апельсинами и вернул ему " + right + " таких ящиков. ";
            };
            case DIVIDE -> switch (story) {
                case APPLES -> "Пришёл злой Виктор со своими друзьями. Теперь Олегу нужно разделить свои яблоки поровну (очень-очень поровну) между " + right + " людьми. ";
                case ORANGES -> "Пришёл злой Виктор со своими друзьями. Теперь Олегу нужно разделить свои апельсины поровну (очень-очень поровну) между " + right + " людьми. ";
            };
        };
        text += switch (story) {
